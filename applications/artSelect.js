...
export default class ArtSelect extends FormApplication {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            id: "scene-background-browser-art-select",
            classes: ["sheet"],
            template: "modules/scene-background-browser/templates/artSelect.html",
            resizable: true,
            minimizable: false,
        });
    }
    ...
    activateListeners(html) {
        ...
        const boxes = html.find(`.scene-background-browser-box`);
        boxes.map((box) => {
